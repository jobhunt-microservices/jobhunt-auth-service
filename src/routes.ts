...
import { searchGigsRoutes } from '@auth/routes/search-gig.route';
...
export const appRoutes = (app: Application) => {
  app.use(BASE_PATH, verifyGatewayRequest, seedRoutes.routes());
  ...
  app.use(BASE_PATH, verifyGatewayRequest, searchGigsRoutes.routes());
};
